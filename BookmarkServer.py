...
class ThreadHTTPServer(ThreadingMixIn, http.server.BaseHTTPRequestHandler):
    def do_GET(self):
    ...
    def do_POST(self):
        ...
        if "longuri" not in params or "shortname" not in params:
            ...
            self.send_header('Content-type', 'text/html')
            self.end_headers()
            self.wfile.write('longuri or shortname is not in the params.')
        ...
        if CheckURI(longuri):
            ...
            self.send_header('Content-type', 'text/html')
            self.end_headers()
            self.wfile.write('Did not successfully fetch the long URI.')
